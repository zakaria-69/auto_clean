  ...
  return (
    <section className="information_container">
      ...
      <section className="information_container_subcontainer">
        <h1>Auto clean Lyon</h1>
        <p className="information_container_subcontainer_whereAndWhen">
          Où et quand ?
        </p>
      ...
      <div className="about_me">
        <p>
          Ce site ne fournis aucun réel service de netoyage de véhicule tout les
          services proposé sont fictifs. Ce site est un site vitrine réalisé
          dans le cadre d&apos;un projet personnel. Je suis Zakaria Ladjrafi
          développeur fullstack vous pouvez découvrir mes réseau via les liens
          présent dans les menus.
        </p>
        <p>Merci !</p>
      </div>
      <Footer />
